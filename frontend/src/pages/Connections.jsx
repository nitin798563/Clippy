...
const Connections = () => {
  ...
  const acceptConnecion = async (userId) => {
    try {
            ...
            <div key={user._id} className='w-full max-w-88 flex gap-5 p-6 bg-white shadowrounded-md'>
              ...
              <div className='flex-1'>
                ...
                <div className='flex max-sm:flex-col gap-2 mt-4'>
                  ...
                  {
                    currentTab === "Pending" && (
                      <button onClick={() => acceptConnecion(user._id)} className='w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-black active:scale-95 transition cursor-pointer'>
                        Accept
                      </button>
                    )
                  }
